...
export default class Hikes {
  constructor(elementId) {
    ...
    this.commentHandler = new Comment("hike", "comments");
  }
  ...
  showHikeList() {
    ...
    // show all comments
    this.commentHandler.showCommentsList();
  ...
  showOneHike(hikeName) {
    ...
    // show comment form and comments for specific hike
    this.commentHandler.showCommentsList(hikeName);
    this.commentHandler.addCommentListner(hikeName);
